...
public class GlobalErrorHandler {
  ...
  @ExceptionHandler(WizardAlreadyHasFamiliarException.class)
  @ResponseStatus(code = HttpStatus.BAD_REQUEST)
  public Map<String, Object> handleWizardAlreadyHasFamiliarException (WizardAlreadyHasFamiliarException e, WebRequest webRequest) {
    return createExceptionMessage(e, HttpStatus.BAD_REQUEST, webRequest, LogStatus.MESSAGE_ONLY);
  }
  
  @ExceptionHandler(ResourceNotFoundException.class)
  @ResponseStatus(code = HttpStatus.NOT_FOUND)
  public Map<String, Object> handleResourceNotFoundException (ResourceNotFoundException e, WebRequest webRequest) {
